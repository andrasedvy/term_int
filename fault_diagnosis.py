...
class FaultDiagnosis:
    """
    Szabályalapú diagnosztikai rendszer DC motorhoz.
    Hibák: Súrlódás, Áramhiba, Túlmelegedés
    Kimenet: címkemátrix + javasolt karbantartási intézkedések
    """
    def __init__(self,
                 friction_thresh=0.2,
                 current_thresh=6.5,
    ...
    def suggest_actions(self, labels):
        ...
        if summary[2] > 0:
            actions.append("🌡️ Túlmelegedés: Tisztítsa a hűtőrendszert, csökkentse a terhelést, állítsa le a rendszert.")
